...
public class SortedMatrix {
    ...
    // search in the row privided between the columns provided
    ...
    static int [] search(int[][] matrix,int target) {
        ...
        while (rowStart < (rowEnd  - 1)) { // while this is true, it'll have more than two rows
        ...
        // otherwise, search in first quarter
